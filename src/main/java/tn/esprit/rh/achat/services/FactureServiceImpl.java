...
public class FactureServiceImpl implements IFactureService {
     ...
     */
    private Facture addDetailsFacture(Facture f, Set<DetailFacture> detailsFacture) throws NotFoundException {
    ...
    @Override
    public List<Facture> getFacturesByFournisseur(Long idFournisseur) throws NotFoundException {
        Fournisseur fournisseur = fournisseurRepository.findById(idFournisseur).orElse(null);
        if (fournisseur == null) {
            throw new NotFoundException("forunisseur not found");
        }
        return (List<Facture>) fournisseur.getFactures();
    }

    @Override
    public void assignOperateurToFacture(Long idOperateur, Long idFacture) throws NotFoundException {
        ...
        if (operateur == null) {
            throw new NotFoundException("operateur not found");
        }
